...
if os.path.exists(os.path.join(ROOT_DIR, "ubpf_michel")):
...
def main():
    ...
    if 'raw' in data:
        ...
        code = ubpf_michel.assembler.assemble(data['asm'])
    else:
        code = None
    ...
    if 'asm' in data:
        ...
        writefile('asm', ubpf_michel.disassembler.disassemble(code))
