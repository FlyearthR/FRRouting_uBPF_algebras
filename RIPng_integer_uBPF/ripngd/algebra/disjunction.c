...
static size_t s_packet(algebra* this, metric m)
{
    ...
    {
    case 0:
        return sizeof(uint8_t)+size_packet(a0, d->m);
    case 1:
        return sizeof(uint8_t)+size_packet(a1, d->m);
    default:
...
static settable_metric w_packet(algebra* this, metric m, settable_metric p)
{
    ...
    case 0:
        *p2 = d->a;
        return write_packet(a0, d->m, (settable_metric) ++p2);
    case 1:
        *p2 = d->a;
        return write_packet(a1, d->m, (settable_metric) ++p2);
    default:
        *p2 = d->a;
        return ++p2;
    }
...
static metric p_packet(algebra* this, metric packet)
{
    ...
    struct disjunct* ret = cust_malloc(sizeof(struct disjunct));
    ...
    {
    case 0:
        ret->m = parse_packet(a0, (metric) ++p);
        break;
    case 1:
        ret->m = parse_packet(a1, (metric) ++p);
        break;
    default:
        ret->m = NULL;
        break;
