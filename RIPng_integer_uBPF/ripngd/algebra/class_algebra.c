...
algebra* constructor_algebra_bdd(int n, int m)
{
    ...
    this->equals_p = equals_p_bdd;
    this->get_p = get_p_bdd;
...
algebra* constructor_algebra_maj(int n)
{
    ...
    tab[0] = n;
    constructor_algebra_int(this);
    this->equals_p = equals_p_maj;
    this->get_p = get_p_maj;
...
void constructor_algebra_seq(algebra* this)
{
    ...
    this->s_packet = &s_packet_seq;
    this->w_packet = &w_packet_seq;
    this->p_packet = &p_packet_seq;
}
